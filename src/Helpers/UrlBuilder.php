...
class UrlBuilder
{
    ...
    const RESOURCE_CHECK_EMAIL = 'resource/EmailExistsResource/execGet';
     ...
     * Topics
     */
    const RESOURCE_GET_TOPIC_FEED = 'resource/TopicFeedResource/execGet';
    const RESOURCE_GET_TOPIC = 'resource/TopicResource/execGet';
