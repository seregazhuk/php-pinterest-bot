...
class ProvidersContainerTest extends PHPUnit_Framework_TestCase
{
    ...
    /** @test */
    public function it_returns_provider_instance()
    {
    ...
    /** @test */
    public function it_returns_request_instance()
    {
        $this->assertInstanceOf(Request::class, $this->container->getRequest());
    }

    /** @test */
    public function it_returns_response_instance()
    {
     ...
     */
    public function it_throws_exception_on_getting_wrong_provider()
    {
